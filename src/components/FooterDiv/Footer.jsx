  ...
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center'>
      ...
      <div>
        ...
        <p className='text-white pb-[13px] opacity-75 leading-7'>We always make our seekers and companies find the best jobs and employers find the best candidates.</p>
      </div>
      ...
      <div className="grid">
        ...
        <div >
          <small className='text-[14px] text-white'>Andrianadirashvili4@gmail.com</small>
          <div className='icons flex gap-4 py-[1rem]'>
            <AiFillInstagram className='h-[35px] w-[35px]'/>
            <BsFacebook className=' h-[35px] w-[35px] '/>
            <AiOutlineTwitter className=' h-[35px] w-[35px] '/>
          </div>
        </div>
      </div>
